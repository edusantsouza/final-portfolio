  ...
  return (
    <form ref={form} onSubmit={sendEmail} className='contact__form' id="contact-form">
      <div className="form-item">
        ...
        <input type="text" name='username' value={value.username} onChange={handleInputChanges} placeholder='Insira seu nome' />
      </div>
      <div className="form-item">
        <label htmlFor="email">E-mail</label>
        <input type="email" name='useremail' value={value.useremail} onChange={handleInputChanges} placeholder='Insira seu e-mail' />
      </div>
      <div className="form-item">
        <label htmlFor="message">Projeto</label>
        <textarea name="message" value={value.message} onChange={handleInputChanges} id="message" cols="30" rows="10"></textarea>
      </div>
